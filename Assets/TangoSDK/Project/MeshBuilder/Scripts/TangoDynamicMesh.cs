...
/// </summary>
public class TangoDynamicMesh : MonoBehaviour, ITango3DReconstruction, ITangoPose
{
    /// <summary>
    ...
    /// 
    ///     Callback function from ITangoPose interface.  Everytime a pose is
    ///     received, check to see if it is a pose we recognize from somewhere
    ///     along our path.  If we recognize it, then we have formed a loop.
    ///     Reorient all our meshes.
    /// </summary>
